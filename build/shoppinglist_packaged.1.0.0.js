...
/***/ function(module, exports, __webpack_require__) {
	...
	var _shoppinglist = __webpack_require__(1);
	...
	$(document).ready(function () {
		...
		if (localStorage.items) {
			myshoppinglist = new _shoppinglist.Shoppinglist(JSON.parse(localStorage.items));
		} else {
			myshoppinglist = new _shoppinglist.Shoppinglist();
		...
		for (var index in myshoppinglist.items) {
...
/***/ function(module, exports) {
	...
	var Shoppinglist = exports.Shoppinglist = function () {
